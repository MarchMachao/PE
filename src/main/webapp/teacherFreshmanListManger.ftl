...
<div class="b-wrapper">
    ...
    <div style="width: 50%;margin: 0 auto;">
     <table class="table table-hover" style="text-align: center;">
		  ...
		  <#list subjuectList as check>
				<tr>
					<td>${check}</td>
					<td><button class="btn btn-info" onclick="window.location.href='turnToManger.do?subjectname=${check}'">打开成绩表</button></td>
				</tr>
		 </#list>
	</table>
   </div>
