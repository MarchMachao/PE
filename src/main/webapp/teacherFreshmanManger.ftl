		...
		<form id="editInfoForm" method="post" enctype="multipart/form-data" style="margin:0;padding:10px 40px">
			<table cellpadding="5">
				...
				<tr>
					<td>800m:</td>
					<td>
						<input class="easyui-textbox" type="text" id="eightm_minuite" name="eightm_minuite"  style="width: 85px; height: 32px">分</input>
						<input class="easyui-textbox" type="text" id="eightm_second" name="eightm_second"  style="width: 85px; height: 32px">秒</input>
					</td>
				</tr>
				<tr>
					<td>1000m:</td>
					<td>
						<input class="easyui-textbox" type="text" id="tenm_minuite" name="tenm_minuite"  style="width: 85px; height: 32px">分</input>
						<input class="easyui-textbox" type="text" id="tenm_second" name="tenm_second"  style="width: 85px; height: 32px">秒</input>
					</td>
				</tr>
				<tr>
					<td>仰卧起坐:</td>
...
// 				$('#editInfoForm').form('clear');
				...
				$('#editInfoForm').form('load',{
											   ...
											   gender:row.gender,
											   pull_up:row.pull_up,
											   eightm_minuite:eightms[0],
											   eightm_second:eightms[1],
											   tenm_minuite:tenms[0],
											   tenm_second:tenms[1]
											   });
			} else {
