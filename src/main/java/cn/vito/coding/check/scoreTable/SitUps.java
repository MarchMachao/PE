		...
		if ("大一大二".contains(g)) {
			if (sitNum < 62) {
				if (sitNum < 16) {
					...
					return 95;
				} else if (sitNum >= 56 && sitNum < 58) {
					return 100;
				} else if (sitNum >= 58 && sitNum < 60) {
					return 101;
				} else {
					return 102;
				}
			} else if (sitNum >= 62 && sitNum <= 69) {
				return 41 + sitNum;
			} else {
				return 110;
			}
			...
			if (sitNum < 63) {
				if (sitNum < 17) {
					...
					return 95;
				} else if (sitNum >= 57 && sitNum < 59) {
					return 100;
				} else if (sitNum >= 59 && sitNum < 61) {
					return 101;
				} else {
					return 102;
				}
			} else if (sitNum >= 63 && sitNum <= 70) {
				return 40 + sitNum;
			} else {
				return 110;
			}
